    ...
    <section className="relative h-screen w-full">
      ...
      <div className="relative z-10 flex h-full flex-col items-center justify-center px-6 text-center text-white pt-20 sm:pt-0">
        <h1 className="relative group mx-auto max-w-3xl text-4xl font-extrabold leading-tight tracking-tight text-center sm:text-5xl lg:text-[52px] drop-shadow-[0_2px_8px_rgba(0,0,0,0.35)] animate-slideInLeft">
          ...
          <span className="absolute -bottom-3 left-1/2 w-0 h-[2px] bg-gradient-to-r from-[#CD1516] via-red-600 to-[#47CE0C] rounded-full transform -translate-x-1/2 animate-underlineAppear animation-delay-600 opacity-70"></span>
        </h1>
        <p className="relative group mt-3 max-w-2xl text-lg font-medium text-white/85 sm:text-xl animate-slideInLeft animation-delay-200">
          ...
          <span className="absolute -bottom-2 left-1/2 w-0 h-[2px] bg-gradient-to-r from-[#CD1516] via-red-600 to-[#47CE0C] rounded-full transform -translate-x-1/2 animate-underlineAppear animation-delay-800 opacity-70"></span>
        </p>
        <div className="mt-8 flex flex-wrap items-center justify-center gap-5 animate-slideInLeft animation-delay-400">
          ...
          <a
            href="/quote"
            className="group relative overflow-hidden rounded-lg bg-gradient-to-r from-[#CD1516] to-[#47CE0C] px-6 py-3 text-lg font-semibold text-white shadow-[0_10px_30px_rgba(0,0,0,0.25)] transition-all duration-500 ease-out hover:scale-[1.05] hover:shadow-[0_20px_50px_rgba(0,0,0,0.4)] focus:outline-none focus:ring-2 focus:ring-white/30"
          >
