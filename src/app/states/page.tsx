    ...
    <main className="relative z-10 min-h-screen">
      <section className="mx-auto max-w-7xl px-4 pt-28 pb-10 text-center sm:pt-32">
        ...
        <div className="mt-6 flex flex-col items-center justify-center gap-3 sm:flex-row">
          <a href="/quote" className="group relative overflow-hidden rounded-lg bg-[#CD1516] px-5 py-3 font-semibold text-white shadow-sm transition hover:scale-[1.02] focus:outline-none focus:ring-2 focus:ring-white/30" aria-label="Get quote">
